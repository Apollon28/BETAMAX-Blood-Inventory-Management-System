...
INSERT INTO `customerdetails` (`id`, `customerName`, `dateofbirth`, `gender`, `occupation`, `currentaddress`, `permanentaddress`, `number`, `email`, `donorno`) VALUES
(1, 'Alice Johnson', '1992-11-05', 'Female', 'Doctor', '123 Health St, Cityville', '456 Wellness Rd, Hometown', '555-1234', 'alice.johnson@example.com', 'C001'),
(2, 'Bob Brown', '1988-02-14', 'Male', 'Engineer', '789 Industry Ave, Metropolis', '101 Tech Blvd, Village', '555-5678', 'bob.brown@example.com', 'C002');
